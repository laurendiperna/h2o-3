...
Candel, A., Parmar, V., LeDell, E.,  and Arora, A. (\shortmonthname\ \the\year). {\textit{Deep Learning with H2O}}. {\url{http://h2o.ai/resources}}.
...
\item automatic imputation of missing values (optional)
...
\waterExampleInR
\lstinputlisting[style=R]{DeepLearning_Vignette_code_examples/deeplearning_quantile.R}

To predict the 80-th percentile of the petal length of the Iris dataset in Python, use the following:

\waterExampleInPython
\lstinputlisting[style=python]{DeepLearning_Vignette_code_examples/deeplearning_quantile.py}
...
\waterExampleInR
\lstinputlisting[style=R]{DeepLearning_Vignette_code_examples/deeplearning_gridsearch_random.R}

\waterExampleInPython
\lstinputlisting[style=python]{DeepLearning_Vignette_code_examples/deeplearning_gridsearch_random.py}
